      ...
      <section className="hero-section">
        ...
        <div className="hero-content">
          ...
          <div className="hero-actions">
            ...
            <button className="secondary-cta" onClick={() => setDemoOpen(true)}><Play size={15} fill="currentColor" /> WATCH DEMO</button>
          </div>
        </div>
