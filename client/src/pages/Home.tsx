    ...
    <main className="min-h-screen overflow-hidden bg-[#050817] text-white">
      ...
      <header className="site-header">
        ...
        <div className="header-actions">
          ...
          <Link href="/auth" className="launch-button">LAUNCH APP <ArrowUpRight size={15} /></Link>
      ...
      <section className="hero-section">
        ...
        <div className="hero-content">
          ...
          <div className="hero-actions">
            <Link href="/auth" className="primary-cta">START TRADING <ArrowUpRight size={18} /></Link>
      ...
      <section id="ai-core" className="section-shell container-wide ai-section">
        <div className="ai-copy"><p className="section-kicker">AUTOPILOT ENGAGED</p><h2>AI ASSIST &amp;<br /><span>COPYTRADE MESH</span></h2><p>Why trade alone when you can harness swarm intelligence? VectorTrade fuses market sentiment, liquidity signals, and verified trader behavior into one responsive execution layer.</p><div className="feature-list"><div><span><Sparkles size={16} /></span><div><h3>AI Trade Assistant</h3><p>Build a portfolio, analyze earnings, or set volatility-aware risk controls from a natural-language prompt.</p></div></div><div id="copytrade"><span><Copy size={16} /></span><div><h3>Alpha Copytrading</h3><p>Follow ranked strategies across crypto, forex, and options with transparent sizing and performance context.</p></div></div></div><Link href="/auth" className="text-link">VIEW LIVE TERMINAL <ArrowUpRight size={16} /></Link></div>
